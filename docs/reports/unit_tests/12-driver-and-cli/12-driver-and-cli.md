...
[`evidence_driver.md`](evidence_driver.md) and [`evidence_cli.md`](evidence_cli.md). Both are
regenerated by `scripts/test-evidence.sh`, so this report can be re-verified against the code
rather than trusted.
